...
// ExtendedTestCase represents a test case with metadata
...
// GenerateExtendedTestCases creates comprehensive test cases
func GenerateExtendedTestCases() []ExtendedTestCase {
	var cases []ExtendedTestCase
	
	// Edge cases
	cases = append(cases, []ExtendedTestCase{
		{"", "Empty string", "edge"},
		{" ", "Single space", "edge"},
		{"\t", "Single tab", "edge"},
		{"\n", "Single newline", "edge"},
